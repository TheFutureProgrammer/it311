...
if (isset($_POST["submit"])) {
   ...
   $email = $_POST['email'];
   $id = $_POST['id'];
   $gender = isset($_POST['gender']) ? $_POST['gender'] : ''; // Use the selected gender value

   $sql = "INSERT INTO `admin_table`(`first_name`, `last_name`, `id`, `email`, `gender`) VALUES ('$first_name','$last_name','$id','$email','$gender')";
...
<body>
   ...
   <div class="container">
      <div class="text-center mb-4">
         <!-- <h3>Add New User</h3> -->
         <p class="text-muted">Complete the form below to add a new student information</p>
      </div>
      ...
      <div class="container d-flex justify-content-center">
         <form action="" method="post" style="width:50vw; min-width:300px;">
            ...
            <select name="id" required>
                <option class="class" value="" selected disabled>Subject:</option>
                <?php
                include "db_conn.php";
         ...
         <script>
            document.querySelector('form').addEventListener('submit', function (event) {
               ...
               if (!maleChecked && !femaleChecked) {
                     ...
                     document.getElementById('genderError').innerHTML = ''; // Clear any previous error message
               }
            });
         </script>
